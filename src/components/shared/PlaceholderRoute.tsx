...
const PlaceholderPage: React.FC<PlaceholderProps> = ({ title, description, phaseLabel }) => {
  return (
    <AppShell>
...
export function createPlaceholderRoute(title: string, description: string, phaseLabel: string) {
  return function Component() {
    return <PlaceholderPage title={title} description={description} phaseLabel={phaseLabel} />;
  };
}
